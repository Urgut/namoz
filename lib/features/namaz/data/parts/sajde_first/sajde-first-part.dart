...
class SajdeFirstPart implements IPart {
  String title = 'Сәждеге бару';
  String description =
      '<p>Содан соң &laquo;Аллаһу Акбар&raquo; деп сәждеге барады</p><p>Сәждеге барғанда екі тізе, екі алақан, мұрын мен маңдай жерге тиген кезде &laquo;Субхана Раббиял-а&rsquo;ла&raquo; деп 3 рет айтады.</p>';
  String image = '';
  String audio = "";
  String transcript =
