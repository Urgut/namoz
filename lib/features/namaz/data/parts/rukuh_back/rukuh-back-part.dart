...
class RukuhBackPart implements IPart {
  ...
  String description =
      '<div><p>Рукуғтан тұрып бара жатып: <strong>&laquo;Сәми&rsquo; Аллаһу лимән хамидаһ&raquo;</strong> дейді</p><p>Денесін туралаған кезде <strong>&laquo;Раббәнә уә ләкәл-хамд&raquo;</strong> дейді.</p></div>';
  String image = '';
  String audio = "";
  String transcript =
